...
public class RevueAfficherToutController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        if ((offreDeTravailActuelle != null) && (societeActuelle != null)) {
            ...
            topText.setText("Revues sur " + offreDeTravailActuelle.getJob() + " de " + societeActuelle.getNomSociete());
            ...
            List<Revue> listRevue = revueService.getRevuesParOffre(offreDeTravailActuelle.getId());
    ...
    private Parent creerRevue(
        ...
        Parent parent = null;
        try {
            parent = FXMLLoader.load(getClass().getResource("/app/gui/societe/offre_de_travail/revue/ModeleRevue.fxml"));
    ...
    private void ajouterRevue(ActionEvent event) {
        MainWindowController.chargerInterface(
                getClass().getResource("/app/gui/societe/offre_de_travail/revue/Manipuler.fxml")
        );
    }
    ...
    private void accueil(ActionEvent event) {
        MainWindowController.chargerInterface(getClass().getResource("/app/gui/societe/offre_de_travail/revue/SelectionnerSociete.fxml"));
    }
    ...
    private void rechercher(KeyEvent event) {
        ...
        List<Revue> listRevue = revueService.getRevuesParOffreParObjet(offreDeTravailActuelle.getId(), inputRecherche.getText());
